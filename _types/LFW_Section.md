...
> **What this file is.** The canonical definition of the `LFW_Section` Prototype for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `type: LFW_Section` conform to the contract described below.
