...
> **What this file is.** The canonical definition of the `LFW_Overlay_Story_Circle` Prototype for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `type: LFW_Overlay_Story_Circle` conform to the contract described below.
