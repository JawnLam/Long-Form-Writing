...
Item_ID: type-lfw-overlay-story-circle
title: "LFW_Overlay_Story_Circle Type"
Date_Added: 2026-06-06
Date_Modified: 2026-06-06
Needs_Processing: false
---

# `LFW_Overlay_Story_Circle` — Type Definition

> **What this file is.** The canonical definition of the `LFW_Overlay_Story_Circle` Type for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `type: LFW_Overlay_Story_Circle` conform to the contract described below.
...
|-------|------|-----------|-------|
| `type` | string | yes | Must equal `LFW_Overlay_Story_Circle` |
