...
> **What this file is.** The canonical definition of the `LFW_Craft_Log` Prototype for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `type: LFW_Craft_Log` conform to the contract described below.
