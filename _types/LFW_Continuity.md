...
> **What this file is.** The canonical definition of the `LFW_Continuity` Prototype for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `type: LFW_Continuity` conform to the contract described below.
