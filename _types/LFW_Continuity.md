...
Item_ID: type-lfw-continuity
title: "LFW_Continuity Type"
Date_Added: 2026-06-06
Date_Modified: 2026-06-06
Needs_Processing: false
---

# `LFW_Continuity` — Type Definition

> **What this file is.** The canonical definition of the `LFW_Continuity` Type for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `type: LFW_Continuity` conform to the contract described below.
...
|-------|------|-----------|-------|
| `type` | string | yes | Must equal `LFW_Continuity` |
