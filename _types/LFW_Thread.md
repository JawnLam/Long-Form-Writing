...
Item_ID: type-lfw-thread
title: "LFW_Thread Type"
Date_Added: 2026-06-06
Date_Modified: 2026-06-06
Needs_Processing: false
---

# `LFW_Thread` — Type Definition

> **What this file is.** The canonical definition of the `LFW_Thread` Type for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `type: LFW_Thread` conform to the contract described below.
...
- **Thread ≠ Motif ≠ Theme.** Thread is non-fiction's running explicit idea. Motif is fiction's recurring physical element. Theme is fiction's carried-not-declared abstract. The three Types are deliberately distinct.
