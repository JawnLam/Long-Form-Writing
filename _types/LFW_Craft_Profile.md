...
Item_ID: type-lfw-craft-profile
title: "LFW_Craft_Profile Type"
Date_Added: 2026-06-06
Date_Modified: 2026-06-06
Needs_Processing: false
---

# `LFW_Craft_Profile` — Type Definition

> **What this file is.** The canonical definition of the `LFW_Craft_Profile` Type for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `type: LFW_Craft_Profile` conform to the contract described below.
...
|-------|------|-----------|-------|
| `type` | string | yes | Must equal `LFW_Craft_Profile` |
