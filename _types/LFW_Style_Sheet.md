...
Item_ID: type-lfw-style-sheet
title: "LFW_Style_Sheet Type"
Date_Added: 2026-06-06
Date_Modified: 2026-06-06
Needs_Processing: false
---

# `LFW_Style_Sheet` — Type Definition

> **What this file is.** The canonical definition of the `LFW_Style_Sheet` Type for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `type: LFW_Style_Sheet` conform to the contract described below.
...
|-------|------|-----------|-------|
| `type` | string | yes | Must equal `LFW_Style_Sheet` |
