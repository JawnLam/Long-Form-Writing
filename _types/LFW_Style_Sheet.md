...
> **What this file is.** The canonical definition of the `LFW_Style_Sheet` Prototype for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `type: LFW_Style_Sheet` conform to the contract described below.
