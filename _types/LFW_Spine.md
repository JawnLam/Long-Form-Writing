...
> **What this file is.** The canonical definition of the `LFW_Spine` Prototype for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `type: LFW_Spine` conform to the contract described below.
