...
Item_ID: type-lfw-spine
title: "LFW_Spine Type"
Date_Added: 2026-06-06
Date_Modified: 2026-06-06
Needs_Processing: false
---

# `LFW_Spine` — Type Definition

> **What this file is.** The canonical definition of the `LFW_Spine` Type for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `type: LFW_Spine` conform to the contract described below.
...
|-------|------|-----------|-------|
| `type` | string | yes | Must equal `LFW_Spine` |
