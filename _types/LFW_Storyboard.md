...
Item_ID: type-lfw-storyboard
title: "LFW_Storyboard Type"
Date_Added: 2026-06-06
Date_Modified: 2026-06-06
Needs_Processing: false
---

# `LFW_Storyboard` — Type Definition

> **What this file is.** The canonical definition of the `LFW_Storyboard` Type for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `type: LFW_Storyboard` conform to the contract described below.
