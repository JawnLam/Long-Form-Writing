...
> **What this file is.** The canonical definition of the `LFW_Voice_Samples` Prototype for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `type: LFW_Voice_Samples` conform to the contract described below.
