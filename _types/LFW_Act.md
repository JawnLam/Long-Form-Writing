...
# `LFW_Act` — Type Definition

> **What this file is.** The canonical definition of the `LFW_Act` Type for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `type: LFW_Act` conform to the contract described below.
