...
- **BETA-PREP** → `_writing-engine/04-ITEMS-AND-STRUCTURE.md`, `_writing-engine/05-VOICE-AND-CRAFT.md`, `_writing-engine/07-REVISION-DISCIPLINE.md`, `_writing-engine/08-FINISHING.md`, `_writing-engine/09-WRITER-DEVELOPMENT.md`, `_writing-engine/16-WRITER-WEATHER-AND-MIDDLE-AUDIT.md`, `_writing-engine/_meta/FAILURE-MODES.md`
...
- **DRAFT** → `_writing-engine/04-ITEMS-AND-STRUCTURE.md`, `_writing-engine/05-VOICE-AND-CRAFT.md`, `_writing-engine/09-WRITER-DEVELOPMENT.md`, `_writing-engine/16-WRITER-WEATHER-AND-MIDDLE-AUDIT.md`, `_writing-engine/_meta/FAILURE-MODES.md`
...
- **OUTLINE** → `_writing-engine/04-ITEMS-AND-STRUCTURE.md`, `_writing-engine/05-VOICE-AND-CRAFT.md`, `_writing-engine/09-WRITER-DEVELOPMENT.md`, `_writing-engine/16-WRITER-WEATHER-AND-MIDDLE-AUDIT.md`, `_writing-engine/_meta/FAILURE-MODES.md`
...
- **READ-THROUGH** → `_writing-engine/04-ITEMS-AND-STRUCTURE.md`, `_writing-engine/05-VOICE-AND-CRAFT.md`, `_writing-engine/07-REVISION-DISCIPLINE.md`, `_writing-engine/08-FINISHING.md`, `_writing-engine/09-WRITER-DEVELOPMENT.md`, `_writing-engine/16-WRITER-WEATHER-AND-MIDDLE-AUDIT.md`, `_writing-engine/_meta/FAILURE-MODES.md`
...
- **REVISE** → `_writing-engine/04-ITEMS-AND-STRUCTURE.md`, `_writing-engine/05-VOICE-AND-CRAFT.md`, `_writing-engine/07-REVISION-DISCIPLINE.md`, `_writing-engine/09-WRITER-DEVELOPMENT.md`, `_writing-engine/16-WRITER-WEATHER-AND-MIDDLE-AUDIT.md`, `_writing-engine/_meta/FAILURE-MODES.md`
