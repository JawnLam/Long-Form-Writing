...
*Specifically. Mood for a setting? A character beat? A line of dialogue rhythm? Sensory texture? The way a scene-change should feel?*

## How it's working in the prose (if folded-in)

*If status is `folded-in`, name the specific scenes where the inspiration has surfaced. The fold-in is implicit (fiction's compost), not citational.*
