...
Item_ID: prototype-lfw-overlay-heros-journey
Title: "LFW_Overlay_Heros_Journey Prototype"
Date_Added: 2026-06-06
Date_Modified: 2026-06-06
Needs_Processing: false
---

# `LFW_Overlay_Heros_Journey` — Prototype Definition

> **What this file is.** The canonical definition of the `LFW_Overlay_Heros_Journey` Prototype for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `Item_Prototype: LFW_Overlay_Heros_Journey` conform to the contract described below.
...
|-------|------|-----------|-------|
| `Item_Prototype` | string | yes | Must equal `LFW_Overlay_Heros_Journey` |
