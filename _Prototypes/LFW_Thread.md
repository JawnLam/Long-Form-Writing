...
> **What this file is.** The canonical definition of the `LFW_Thread` Prototype for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `Item_Prototype: LFW_Thread` conform to the contract described below.
...
|-------|------|-----------|-------|
| `Item_Prototype` | string | yes | Must equal `LFW_Thread` |
