...
Item_ID: prototype-lfw-section
Title: "LFW_Section Prototype"
Date_Added: 2026-06-06
Date_Modified: 2026-06-06
Needs_Processing: false
---

# `LFW_Section` — Prototype Definition

> **What this file is.** The canonical definition of the `LFW_Section` Prototype for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `Item_Prototype: LFW_Section` conform to the contract described below.
...
|-------|------|-----------|-------|
| `Item_Prototype` | string | yes | Must equal `LFW_Section` |
...
- **Section ≠ Scene.** Sections are non-fiction's per-chapter unit; Scenes are fiction's. The two are deliberately separate Prototypes so per-genre activities and audits can target the right Item type.
