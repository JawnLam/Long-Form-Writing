...
> **What this file is.** The canonical definition of the `LFW_Overlay_Save_The_Cat` Prototype for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `Item_Prototype: LFW_Overlay_Save_The_Cat` conform to the contract described below.
...
|-------|------|-----------|-------|
| `Item_Prototype` | string | yes | Must equal `LFW_Overlay_Save_The_Cat` |
