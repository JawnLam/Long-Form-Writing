...
> **What this file is.** The canonical definition of the `LFW_Manuscript_Manifest` Prototype for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `Item_Prototype: LFW_Manuscript_Manifest` conform to the contract described below.
...
|-------|------|-----------|-------|
| `Item_Prototype` | string | yes | Must equal `LFW_Manuscript_Manifest` |
