...
Item_ID: prototype-lfw-voice-samples
Title: "LFW_Voice_Samples Prototype"
Date_Added: 2026-06-06
Date_Modified: 2026-06-06
Needs_Processing: false
---

# `LFW_Voice_Samples` — Prototype Definition

> **What this file is.** The canonical definition of the `LFW_Voice_Samples` Prototype for the Long-Form-Writing Operating Volume. Items in any cartridge that declare `Item_Prototype: LFW_Voice_Samples` conform to the contract described below.
...
|-------|------|-----------|-------|
| `Item_Prototype` | string | yes | Must equal `LFW_Voice_Samples` |
